...
## A2A Trust Audit — 🔴 **Grade F** (45/100)

**Agent:** `Microquery` v1.0.0 · **Fetched:** `/tmp/microquery-card.json`
...
- **L4 · Audit trail URL** `[high]` — No audit trail — actions are unverifiable after the fact.
